        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if(isset($_GET['p_id'])){
                    ...
                    $get_the_post_query = mysqli_query($connection, $query);
                    
                    While ($row = mysqli_fetch_assoc($get_the_post_query)) {
                ...
                <div class="well">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            <label for="email" class="for">E-mail</label>
                            <input class="form-control" type="email" name="email">
                        </div>
                        <div class="form-group">
                            <label for="comment" class="for">Your Comment</label>
                ...
                $query = "SELECT * FROM comments 
                          WHERE (comment_status = 'Approved' AND 
